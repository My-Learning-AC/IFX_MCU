 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_Clock/V0.2.2.1.11
...
/** \brief Length for Ifx_CLOCK_OSCCON_Bits.AMPCTL */
#define IFX_CLOCK_OSCCON_AMPCTL_LEN (2u)

/** \brief Mask for Ifx_CLOCK_OSCCON_Bits.AMPCTL */
#define IFX_CLOCK_OSCCON_AMPCTL_MSK (0x3u)

/** \brief Offset for Ifx_CLOCK_OSCCON_Bits.AMPCTL */
#define IFX_CLOCK_OSCCON_AMPCTL_OFF (2u)
