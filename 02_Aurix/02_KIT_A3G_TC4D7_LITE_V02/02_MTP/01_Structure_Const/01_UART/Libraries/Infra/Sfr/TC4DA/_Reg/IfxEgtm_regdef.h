 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_EGTM/V0.2.0.0.11
...
typedef struct _Ifx_EGTM_CLS_AEI_BRIDGE_MODE_Bits
{
    ...
    __IO Ifx_Strict_32Bit BYPASS_SYNC:1;    /**< \brief [2:2] Bypass synchronizer flipflops (rw) */
...
typedef struct _Ifx_EGTM_CLS_ATOM_CH_STAT_Bits
{
    ...
    __I  Ifx_Strict_32Bit DR:1;            /**< \brief [23:23] ##suppress##ARUdata rejected flag##suppress## (rh) */
...
/** \brief ICM_IRQG_ATOM_[g]_CI in cluster 0 */
...
/** \brief ICM_IRQG_CLS_[g]_MEI in cluster 0 */
...
/** \brief ICM_IRQG_TOM_[g]_CI in cluster 0 */
...
{
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL0:2;    /**< \brief [1:0] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL1:2;    /**< \brief [3:2] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL2:2;    /**< \brief [5:4] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL3:2;    /**< \brief [7:6] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL4:2;    /**< \brief [9:8] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL5:2;    /**< \brief [11:10] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL6:2;    /**< \brief [13:12] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_CTRL7:2;    /**< \brief [15:14] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __I  Ifx_Strict_32Bit :16;             /**< \brief [31:16] \internal Reserved */
...
{
    __IO Ifx_Strict_32Bit SPE_OUT_PAT0:2;    /**< \brief [1:0] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_PAT1:2;    /**< \brief [3:2] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_PAT2:2;    /**< \brief [5:4] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_PAT3:2;    /**< \brief [7:6] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_PAT4:2;    /**< \brief [9:8] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_PAT5:2;    /**< \brief [11:10] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_PAT6:2;    /**< \brief [13:12] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __IO Ifx_Strict_32Bit SPE_OUT_PAT7:2;    /**< \brief [15:14] ##suppress##SPE output control value for TOM channel0 to TOM channel7 (SPE[i]_OUT[o:o])##suppress## (rw) */
    __I  Ifx_Strict_32Bit :16;             /**< \brief [31:16] \internal Reserved */
...
/** \brief Instance Selection for TIM0 channel0 */
typedef struct _Ifx_EGTM_TIMS_CH_ADCSEL_Bits
{
    __I  Ifx_UReg_32Bit :32;               /**< \brief [31:0] \internal Reserved */
...
{
       __I  Ifx_EGTM_CLS_ARCH_REV               REV;                    /**< \brief 0, eGTM version control register in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_RST               RST;                    /**< \brief 4, eGTM global reset register in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_CTRL              CTRL;                   /**< \brief 8, eGTM global control register in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_CFG               CFG;                    /**< \brief C, eGTM configuration register in cluster 0*/
       __I  Ifx_EGTM_CLS_ARCH_AEI_ADDR_XPT      AEI_ADDR_XPT;           /**< \brief 10, GTM_AEI_ADDR_XPT in cluster 0*/
       __I  Ifx_EGTM_CLS_ARCH_AEI_STA_XPT       AEI_STA_XPT;            /**< \brief 14, GTM_AEI_STA_XPT in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_IRQ_NOTIFY        IRQ_NOTIFY;             /**< \brief 18, eGTM Interrupt notification register in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_IRQ_EN            IRQ_EN;                 /**< \brief 1C, eGTM interrupt enable register in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_EIRQ_EN           EIRQ_EN;                /**< \brief 20, eGTM error interrupt enable register in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_IRQ_FORCINT       IRQ_FORCINT;            /**< \brief 24, eGTM Software interrupt generation register in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_IRQ_MODE          IRQ_MODE;               /**< \brief 28, eGTM toplevel interrupts mode selection in cluster 0*/
       __IO Ifx_EGTM_CLS_ARCH_CLK_CFG           CLK_CFG;                /**< \brief 2C, eGTM Cluster Clock Configuration in cluster 0*/
...
{
       __IO Ifx_EGTM_CLS_CMU_CLKX_CTRL          CTRL;                   /**< \brief 0, CMU control for clock resolution generator [x] in cluster 0*/
...
{
       __IO Ifx_EGTM_CLS_CMU_ECLK_NUM           NUM;                    /**< \brief 0, The numerator for the external clock resolution generator [z] in cluster 0*/
       __IO Ifx_EGTM_CLS_CMU_ECLK_DEN           DEN;                    /**< \brief 4, The denominator for the external clock resolution generator [z] in cluster 0*/
...
{
       __IO Ifx_EGTM_CLS_CMU_CLK_EN             CLK_EN;                 /**< \brief 0, CMU clock enable in cluster 0*/
       __IO Ifx_EGTM_CLS_CMU_GCLK_NUM           GCLK_NUM;               /**< \brief 4, The numerator for CMU global clock resolution generator in cluster 0*/
       __IO Ifx_EGTM_CLS_CMU_GCLK_DEN           GCLK_DEN;               /**< \brief 8, The denominator for CMU global clock resolution generator in cluster 0*/
       ...
       __IO Ifx_EGTM_CLS_CMU_CLK_6_CTRL         CLK_6_CTRL;             /**< \brief 24, CMU control for clock resolution generator 6 in cluster 0*/
       __IO Ifx_EGTM_CLS_CMU_CLK_7_CTRL         CLK_7_CTRL;             /**< \brief 28, CMU control for clock resolution generator 7 in cluster 0*/
       __IO Ifx_EGTM_CLS_CMU_ECLK               ECLK[3];                /**< \brief 2C, */
       __IO Ifx_EGTM_CLS_CMU_FXCLK_CTRL         FXCLK_CTRL;             /**< \brief 44, CMU control for selection of FCR subblock input in cluster 0*/
       __I  Ifx_UReg_8Bit                       reserved_48[4];         /**< \brief 48, \internal Reserved */
       __IO Ifx_EGTM_CLS_CMU_CLK_CTRL           CLK_CTRL;               /**< \brief 4C, CMU control for clock resolution generator in cluster 0*/
} Ifx_EGTM_CLS_CMU;
...
{
       __IO Ifx_EGTM_CLS_TBU_CH_BASE            BASE;                   /**< \brief 0, TBU channel [x] base in cluster 0*/
} Ifx_EGTM_CLS_TBU_CH;
...
{
       __IO Ifx_EGTM_CLS_TBU_CHEN               CHEN;                   /**< \brief 0, TBU global channel enable in cluster 0*/
       __IO Ifx_EGTM_CLS_TBU_CH0_CTRL           CH0_CTRL;               /**< \brief 4, TBU channel 0 control in cluster 0*/
       __IO Ifx_EGTM_CLS_TBU_CH0_BASE           CH0_BASE;               /**< \brief 8, TBU channel 0 base in cluster 0*/
       __IO Ifx_EGTM_CLS_TBU_CH1_CTRL           CH1_CTRL;               /**< \brief C, TBU channel 1 control in cluster 0*/
        __IO Ifx_EGTM_CLS_TBU_CH                 CH1;                    /**< \brief 10, */
       __IO Ifx_EGTM_CLS_TBU_CH2_CTRL           CH2_CTRL;               /**< \brief 14, TBU channel 2 control in cluster 0*/
...
{
       __I  Ifx_EGTM_CLS_ICM_IRQG_CLS_MEI       MEI;                    /**< \brief 0, ICM_IRQG_CLS_[g]_MEI in cluster 0*/
...
{
       __I  Ifx_EGTM_CLS_ICM_IRQG_ATOM_CI       CI;                     /**< \brief 0, ICM_IRQG_ATOM_[g]_CI in cluster 0*/
...
{
       __I  Ifx_EGTM_CLS_ICM_IRQG_TOM_CI        CI;                     /**< \brief 0, ICM_IRQG_TOM_[g]_CI in cluster 0*/
...
{
       __I  Ifx_EGTM_CLS_ICM_IRQG_0             IRQG_0;                 /**< \brief 0, ICM_IRQG_0 in cluster 0*/
       __I  Ifx_UReg_8Bit                       reserved_4[4];          /**< \brief 4, \internal Reserved */
       __I  Ifx_EGTM_CLS_ICM_IRQG_2             IRQG_2;                 /**< \brief 8, ICM Interrupt group register covering TIM0, TIM1, TIM2, TIM3 in cluster 0*/
       __I  Ifx_UReg_8Bit                       reserved_C[36];         /**< \brief C, \internal Reserved */
       __I  Ifx_EGTM_CLS_ICM_IRQG_MEI           IRQG_MEI;               /**< \brief 30, ICM Interrupt group register for module error interrupt information in cluster 0*/
       __I  Ifx_UReg_8Bit                       reserved_34[4];         /**< \brief 34, \internal Reserved */
       __I  Ifx_EGTM_CLS_ICM_IRQG_CEI1          IRQG_CEI1;              /**< \brief 38, ICM Interrupt group register 1 for channel error interrupt information in cluster 0*/
       __I  Ifx_UReg_8Bit                       reserved_3C[120];       /**< \brief 3C, \internal Reserved */
       __I  Ifx_EGTM_CLS_ICM_IRQG_SPE_CEI       IRQG_SPE_CEI;           /**< \brief B4, ICM Interrupt group SPE for module Error Interrupt information in cluster 0*/
       ...
       __I  Ifx_EGTM_CLS_ICM_IRQG_SPE_CI        IRQG_SPE_CI;            /**< \brief 170, ICM Interrupt group SPE for module Interrupt information in cluster 0*/
...
{
       __IO Ifx_EGTM_CLS_MON_STATUS             STATUS;                 /**< \brief 0, MON status register in cluster 0*/
} Ifx_EGTM_CLS_MON;
...
{
       __IO Ifx_EGTM_CLS_CMP_EN                 EN;                     /**< \brief 0, CMP comparator enable register in cluster 0*/
       __IO Ifx_EGTM_CLS_CMP_IRQ_NOTIFY         IRQ_NOTIFY;             /**< \brief 4, CMP event notification register in cluster 0*/
       __IO Ifx_EGTM_CLS_CMP_IRQ_EN             IRQ_EN;                 /**< \brief 8, CMP interrupt enable register in cluster 0*/
       __IO Ifx_EGTM_CLS_CMP_IRQ_FORCINT        IRQ_FORCINT;            /**< \brief C, CMP interrupt force register in cluster 0*/
       __IO Ifx_EGTM_CLS_CMP_IRQ_MODE           IRQ_MODE;               /**< \brief 10, CMP interrupt mode configuration register in cluster 0*/
       __IO Ifx_EGTM_CLS_CMP_EIRQ_EN            EIRQ_EN;                /**< \brief 14, CMP error interrupt enable register in cluster 0*/
} Ifx_EGTM_CLS_CMP;
...
typedef volatile struct _Ifx_EGTM_CLS_SPE
{
       ...
       __IO Ifx_EGTM_CLS_SPE_OUT_PAT            OUT_PAT[8];             /**< \brief 8, SPE[i] Output Definition Register 0*/
...
{
       __I  Ifx_EGTM_TIMS_CH_ADCSEL             ADCSEL;                 /**< \brief 0, Instance Selection for TIM0 channel0*/
} Ifx_EGTM_TIMS_CH;
...
typedef volatile struct _Ifx_EGTM
{
       ...
       __IO Ifx_EGTM_MSC                        MSC[2];                 /**< \brief 61290, */
       __I  Ifx_UReg_8Bit                       reserved_612B0[32];     /**< \brief 612B0, \internal Reserved */
       ...
       __IO Ifx_EGTM_PSI5S                      PSI5S[1];               /**< \brief 61410, eGTM to PSI5-S0 output trigger selection register*/
       __I  Ifx_UReg_8Bit                       reserved_61414[12];     /**< \brief 61414, \internal Reserved */
