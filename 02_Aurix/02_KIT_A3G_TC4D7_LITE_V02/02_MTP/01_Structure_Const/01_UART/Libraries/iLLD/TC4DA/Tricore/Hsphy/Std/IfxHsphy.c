...
IFX_CONST uint32 IfxHsphy_Sgmii_paramConfig[IfxHsphy_SgmiiSpeed_max][IfxHsphy_XpcsRefClk_max][IfxHsphy_SgmiiParamIndex_maxParamIndex] = {
    ...
    {
        {50,  1, 0, 5, 10, 0,   1000, 10, 1, 0, 0, 2, 2, 1,  1, 1, 15, 0}, /* Parameter values for 25MHz SGMII 100M 1.25gbps mode */
        {125, 2, 0, 6, 12, 0,   1000, 16, 1, 0, 0, 2, 2, 17, 1, 1, 15, 0}, /* Parameter values for 40MHz SGMII 100M 1.25gbps mode */
        {50,  3, 0, 6, 12, 0,   1000, 20, 2, 0, 0, 2, 2, 17, 1, 1, 15, 0}  /* Parameter values for 100MHz SGMII 100M 1.25gbps mode */
    },                                                                     /* values for SGMII 100M 1.25gbps mode. */
    {
        {50,  3, 0, 5, 10, 0,   1000, 10, 1, 0, 0, 2, 2, 17, 1, 1, 15, 0}, /* Parameter values for 25MHz SGMII 100M 125mbps  mode */
        {125, 2, 0, 6, 12, 0,   1000, 16, 1, 0, 0, 2, 2, 17, 1, 1, 15, 0}, /* Parameter values for 40MHz SGMII 100M 125mbps mode */
        {50,  3, 0, 6, 12, 0,   1000, 20, 2, 0, 0, 2, 2, 17, 1, 1, 15, 0}  /* Parameter values for 100MHz SGMII 100M 125mbps mode */
    }
};
