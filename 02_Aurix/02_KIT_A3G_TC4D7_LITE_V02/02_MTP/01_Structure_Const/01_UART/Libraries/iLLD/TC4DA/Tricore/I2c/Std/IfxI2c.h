 ...
 * \return status
 */
IFX_EXTERN IfxI2c_Status IfxI2c_read2(IfxI2c_I2cStdDevice *i2cDevice, volatile uint8 *data, Ifx_SizeT size);
 ...
 * \return status
 */
IFX_EXTERN IfxI2c_Status IfxI2c_write2(IfxI2c_I2cStdDevice *i2cDevice, volatile uint8 *data, Ifx_SizeT size);
