...
IfxI2c_Status IfxI2c_read2(IfxI2c_I2cStdDevice *i2cDevice, volatile uint8 *data, Ifx_SizeT size)
{
...
IfxI2c_Status IfxI2c_write2(IfxI2c_I2cStdDevice *i2cDevice, volatile uint8 *data, Ifx_SizeT size)
{
    Ifx_I2C         *i2c;                     /* pointer to I2C module */
    IfxI2c_Status    status;                  /* status of I2C and driver */
    IfxI2c_BusStatus busStatus;               /* status of I2C bus */
