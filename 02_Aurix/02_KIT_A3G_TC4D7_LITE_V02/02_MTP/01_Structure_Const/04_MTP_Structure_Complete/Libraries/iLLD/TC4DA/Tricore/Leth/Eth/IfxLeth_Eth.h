...
/** \addtogroup IfxLld_Leth_Eth_Interface_Functions
 * \{ */
 ...
 *
 */
IFX_EXTERN void IfxLeth_Eth_configureMacCore(IfxLeth_Eth *leth, IfxLeth_PortIndex portIndex, IfxLeth_Eth_MacConfig *macConfig);
 ...
 * \param data Data read to be performed on the register address in regAddress param
 * \return None
 *
 */
IFX_EXTERN void IfxLeth_Eth_mdio_read_clause22(IfxLeth_Eth *leth, IfxLeth_PortIndex portIndex, uint8 phyAddress, uint8 regAddress, uint16 *data);
 ...
 * \param devAddress device address
 * \param regAddress Register address in the PHY to which read is to be performed
 * \param data Data read/write to be performed on the register address in addr param
 * \param opMode Specify the MDIO read modes i.e. Read only & Post Read Increment addr mode
 * \return None
 *
 */
IFX_EXTERN void IfxLeth_Eth_mdio_read_clause45(IfxLeth_Eth *leth, IfxLeth_PortIndex portIndex, uint8 phyAddress, uint8 devAddress, uint16 regAddress, uint16 *data, IfxLeth_MdioClause45ReadMode opMode);

/** \brief API for MMC Initialization
 * \param geth LETH driver Handle
 * \param portIndex Index of Port
...
/** \addtogroup IfxLld_Leth_Eth_Bridge_Functions
 * \{ */
