...
{
    return (IfxI2c_I2c_Status)IfxI2c_read2((IfxI2c_I2cStdDevice *)i2cDevice, data, size);
}


IfxI2c_I2c_Status IfxI2c_I2c_write2(IfxI2c_I2c_Device *i2cDevice, volatile uint8 *data, Ifx_SizeT size)
{
    return (IfxI2c_I2c_Status)IfxI2c_write2((IfxI2c_I2cStdDevice *)i2cDevice, data, size);
}
