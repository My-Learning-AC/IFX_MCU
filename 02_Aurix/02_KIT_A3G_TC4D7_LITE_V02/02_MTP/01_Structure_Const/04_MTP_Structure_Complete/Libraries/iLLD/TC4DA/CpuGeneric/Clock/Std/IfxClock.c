...
boolean IfxClock_configureCcuPll(const IfxClock_Config *pllCfg)
{
...
#ifndef IFXCLOCK_TC4XX_10MHZ_WORKAROUND
        ...
        (pllCfg->PerClockSourceSelect != IfxClock_PerClockSourceSelect_back))
    {
        ...
        if (pllCfg->SysClockSourceSelect == IfxClock_SysClockSourceSelect_pll)
        {
            ...
            /* Step 1. Check for CCU lock bit with a timeout of at least 100 micro seconds */
            timeoutCycleCount = IFXCLOCK_CCUCON_LCK_BIT_TIMEOUT_COUNT;
            ...
            /* Step 2. Configure K-dividers in SYSPLLCON1 register*/
            /* KxPREDIV = div by 2 and KxDIV = 0x01*/

            CLOCK_SYSPLLCON1.U = IFXCLOCK_SYSPLL_KXDIV_KXPREDIV_INITIAL_VALUE;

            /* Step 3. Check for CCU lock bit with a timeout of at least 100 micro seconds */
            timeoutCycleCount = IFXCLOCK_CCUCON_LCK_BIT_TIMEOUT_COUNT;
            ...
            /* Step 5. Check if PLL is powered: SYSPLLSTAT.PWRSTAT == 1 with a timeout of at least 100 micro seconds*/
            ...
            /* Step 6. Wait for 1ms to avoid jitter */
            IfxClock_waitWithWdtService(IFXCLOCK_SYSPLL_POWERUP_WAITTIME); /* 1 mS */

            /* Step 7. Check for SysPLL lock with a timeout of at least 100 micro seconds*/
            timeoutCycleCount = IFXCLOCK_CCUCON_LCK_BIT_TIMEOUT_COUNT;
            ...
            /* Step 9. Wait for 10 micro seconds  */
            /* Check for CCU lock bit */
            ...
            /* Step 10. Configure KxDIV */
            /* Set KxDIV to final value */
        ...
        if (pllCfg->PerClockSourceSelect == IfxClock_PerClockSourceSelect_pll)
        {
            ...
            /* Step 2. Configure K-dividers in xPLLCON1 register*/
            /* KxPREDIV = div by 2 and KxDIV = 0x01*/

            CLOCK_PERPLLCON1.U = IFXCLOCK_PERPLL_KXDIV_KXPREDIV_INITIAL_VALUE;
            ...
            /* Step 5. Check if PLL is powered: PERPLLSTAT.PWRSTAT == 1 with a timeout of at least 100 micro seconds*/
