...
typedef enum
{
	/**< \brief When MDC clock freq of 2.5MHz (standard MDC freq as per ieee 802.3) */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider42  = 0,  /**< \brief MDC clock is derived as clk_csr/42  applicable when CSR_CLk freq is 60-100MHz */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider62  = 1,  /**< \brief MDC clock is derived as clk_csr/62 applicable when CSR_CLk freq is 100-150MHZ */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider16  = 2,  /**< \brief MDC clock is derived as clk_csr/16 applicable when CSR_CLk freq is 20-35MHZ */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider26  = 3,  /**< \brief MDC clock is derived as clk_csr/26 applicable when CSR_CLk freq is 35-60MHZ */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider102 = 4,  /**< \brief MDC clock is derived as clk_csr/102 applicable when CSR_CLk freq is 150-250MHZ */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider124 = 5,  /**< \brief MDC clock is derived as clk_csr/124 applicable when CSR_CLk freq is 250-300MHZ */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider204 = 6,  /**< \brief MDC clock is derived as clk_csr/204 applicable when CSR_CLk freq is 300-500MHZ */
    IfxLeth_MdioAppClockRangeSel_0CrsDivider324 = 7,  /**< \brief MDC clock is derived as clk_csr/324 applicable when CSR_CLk freq is 500-800MHZ */
	/**< \brief When higher MDC freq greater then STD 2.5MHz freq */
    IfxLeth_MdioAppClockRangeSel_1CrsDivider4   = 8,  /**< \brief MDC clock is derived as clk_csr/4  */
    IfxLeth_MdioAppClockRangeSel_1CrsDivider6   = 9,  /**< \brief MDC clock is derived as clk_csr/6  */
    IfxLeth_MdioAppClockRangeSel_1CrsDivider8   = 10, /**< \brief MDC clock is derived as clk_csr/8  */
    IfxLeth_MdioAppClockRangeSel_1CrsDivider10  = 11, /**< \brief MDC clock is derived as clk_csr/10 */
    IfxLeth_MdioAppClockRangeSel_1CrsDivider12  = 12, /**< \brief MDC clock is derived as clk_csr/12 */
    IfxLeth_MdioAppClockRangeSel_1CrsDivider14  = 13, /**< \brief MDC clock is derived as clk_csr/14 */
	IfxLeth_MdioAppClockRangeSel_1CrsDivider16  = 14, /**< \brief MDC clock is derived as clk_csr/16 */
	IfxLeth_MdioAppClockRangeSel_1CrsDivider18  = 15  /**< \brief MDC clock is derived as clk_csr/18 */
...
typedef enum
{
	...
	IfxLeth_MdioTrailClkCycles_1  = 1,  /**<\briefReference to PLCA control segment of PHY device  */
 ...
 * \return None
 */
IFX_EXTERN void IfxLeth_setupRmiiOuputPins(Ifx_LETH *lethSFR, IfxLeth_PortIndex portIndex, const IfxLeth_RmiiPins *rmiiPins);
 ...
 * \return None
 */
IFX_EXTERN void IfxLeth_setRmiiPins(Ifx_LETH *lethSFR, IfxLeth_PortIndex lethIndex, const IfxLeth_RmiiPins *rmiiPins);

/** \brief Configures MII output pins
 * \param lethSFR LETH module pointer
 * \param rmiiPins Configuration pointer for MII pin
 * \return None
 */
