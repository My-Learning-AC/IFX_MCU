...
typedef enum
{
    ...
    IfxHsphy_PhyIndex_2,        /**< \brief PHY index 2 */
    IfxHsphy_PhyIndex_none      /**< \brief PHY index none */
} IfxHsphy_PhyIndex;
...
typedef enum
{
	...
	IfxHsphy_PhyPowerMode_up       		/**< \brief PHY power mode up */
...
typedef enum
{
    IfxHsphy_EthIndex_0,    /**< \brief ETH index 0 */
    IfxHsphy_EthIndex_1,    /**< \brief ETH index 1 */
    IfxHsphy_EthIndex_max,  /**< \brief Max index for ETH */
    IfxHsphy_EthIndex_none  /**< \brief None */
} IfxHsphy_EthIndex;
