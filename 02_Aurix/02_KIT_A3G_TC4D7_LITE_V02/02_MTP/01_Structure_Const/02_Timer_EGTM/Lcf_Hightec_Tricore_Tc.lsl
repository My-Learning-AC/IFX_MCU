...
MEMORY
{
    ...
    pfls5 (rx): org = 0x81200000, len = 2M - 512K
    pfls5_nc (rx): org = 0xa1200000, len = 2M - 512K
    ...
    lmuram (w!x): org = 0x90400000, len = 5M - 512K
    lmuram_nc (w!x): org = 0xb0400000, len = 5M - 512K
    
    ppu_lmuram (w!x): org = 0x90880000, len = 512K
    ppu_lmuram_nc (w!x): org = 0xb0880000, len = 512K  

    ppu_csm (w!x): org = 0x92080000, len = 512K
    ppu_csm_nc (w!x): org = 0xb2080000, len = 512K
    
    ppu_code (w!x): org = 0x81380000, len = 512K
    ppu_code_nc (w!x): org = 0xa1380000, len = 512K    
}
...
REGION_MIRROR("ppu_code", "ppu_code_nc")
