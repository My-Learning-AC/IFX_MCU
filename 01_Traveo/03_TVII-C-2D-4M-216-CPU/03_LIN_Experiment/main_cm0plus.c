...
#define CY_LINCH0_EN_PIN                        1
#define CY_LINCH0_EN_PIN_MUX                    P2_1_LIN0_LIN_EN0
...
cy_stc_gpio_pin_config_t lin_en_pin_cfg =
{
    .outVal    = 0ul,
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,
    .hsiom     = CY_LINCH0_EN_PIN_MUX,
    .intEdge   = 0ul,
    .intMask   = 0ul,
    .vtrip     = 0ul,
    .slewRate  = 0ul,
...
int main(void)
{
    ...
    PortInit();
    Cy_GPIO_Pin_Init(CY_LINCH0_EN_PORT, CY_LINCH0_EN_PIN, &lin_en_pin_cfg);
    Cy_GPIO_Set(CY_LINCH0_EN_PORT, CY_LINCH0_EN_PIN);
