/***************************************************************************//**
* \file tvii_series_smif_ex_adopter_hflash.h
*
* \version 1.0
*
...
#if !defined(TVII_SERIES_SMIF_EX_ADOPTER_HFLASH_H)
#define TVII_SERIES_SMIF_EX_ADOPTER_HFLASH_H
...
#define TVII_B_H_2D6M defined(CYT4DNDBHS)
  ...
  static void ChangePLLFrequency(uint32_t outputFreq)
  {
      ...
      CY_ASSERT(Cy_SysClk_Pll400MConfigure(PLL_400M_2_PATH_NO , &pll400_2_Config) == CY_SYSCLK_SUCCESS);
...
#endif // TVII_SERIES_SMIF_EX_ADOPTER_HFLASH_H
