...
cy_stc_tdm_config_t config_tdm = 
{
    .tx_config =
    {
        ...
        .txChEN             = 0x03,//(1ul << TDM_CNANNEL_COUNT) - 1ul,
...
bool Init_n_Test_TDM(void)
{
    ...
    return false;   // returning false for only one time execution

}

// Cy_AudioTDM_StopTx(&CY_AUDIOSS_TDM_TYPE->TDM_TX_STRUCT);
