...
typedef struct
{
    ...
    uint16_t u1LOOPBACK                  : 1; /* 1 = Loopback enabled.
                                                 ...
                                                 s gdead timeh before any valid data will appear at the MII receive outputs. */
...
typedef struct
{
    uint16_t u11CODE      : 11; /* Code:
                                   ...
                                   Pageh, as defined in annex 28C of IEEE 802.3u. Otherwise, the code shall be
                                   interpreted as an "Unformatted Pageh, and the interpretation is application
                                   specific.
...
typedef struct
{
    ...
    uint16_t u1PAUSE_RX     : 1; /* Pause Receive Negotiated:
                                    ...
                                    This function shall be enabled according to IEEE 802.3 Annex 28B Table
                                    28B-3, gPause Resolutionh, only if the Auto-Negotiated Highest Common
                                    Denominator is a full duplex technology.
                                     */
