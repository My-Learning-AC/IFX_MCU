...
lset Toc1 9  0x00000000;
lset Toc1 10  0x17007000;
lset Toc1 11 0x17007000; #0x17002000
lset Toc1 12 0x00000000;
puts "Toc1 = $Toc1";
test_compare 0xa0000000 [SROM_WriteRow $SYS_CALL_GREATER32BIT 0 0x17007800 0 $Toc1];
test_end $TestString;
...
set TestString "Test AAxxx: CheckFactoryHash: Should return error code as TOC1 has changed.";
test_start $TestString;
test_compare 0xa0000000 [SROM_CheckFactoryHash $SYS_CALL_LESS32BIT];
test_end $TestString;

set TestString "Test AAxxx: UPDATE TOC1: Restore";
test_start $TestString;
set Toc1 [ReturnSFlashRow $TOC1_ROW_IDX];
puts "Toc1 = $Toc1";
lset Toc1 0  0x00000034;
