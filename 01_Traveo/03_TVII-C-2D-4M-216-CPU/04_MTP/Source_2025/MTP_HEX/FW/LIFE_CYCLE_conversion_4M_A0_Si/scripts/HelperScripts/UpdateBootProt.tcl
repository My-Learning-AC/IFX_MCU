...
set BootProt [ReturnSFlashRow $BOOT_PROT_ROW_IDX];
puts "BootProt = $BootProt";
#set temp [lindex $BootProt 13];
#puts $temp;
#set temp1 [expr ($temp & 0xFFFF0000) | 0xFF93]
set temp1 0x93FF004B;
lset BootProt 13 $temp1;

puts "BootProt = $BootProt";

test_compare 0xa0000000 [SROM_WriteRow $SYS_CALL_GREATER32BIT 0 0x17007000 0 $BootProt];
