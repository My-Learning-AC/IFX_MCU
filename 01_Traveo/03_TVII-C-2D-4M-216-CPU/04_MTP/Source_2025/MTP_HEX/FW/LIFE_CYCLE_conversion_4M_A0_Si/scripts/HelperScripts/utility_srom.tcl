...
proc SYSCALL_LessThan32bits_Alt {data} {
	global SRAM_SCRATCH CYREG_IPC_STRUCT_ACQUIRE CYREG_IPC_STRUCT_DATA CYREG_IPC_STRUCT_NOTIFY;
...
proc Srom_ReturnCheck {IsArgInIPCData} {
	global CYREG_IPC_STRUCT_LOCK_STATUS TRIAL_MAX CYREG_IPC_STRUCT_DATA SRAM_SCRATCH;
	global DUT TVIIBH4M_SILICON TVIIC2D4M_PSVP
