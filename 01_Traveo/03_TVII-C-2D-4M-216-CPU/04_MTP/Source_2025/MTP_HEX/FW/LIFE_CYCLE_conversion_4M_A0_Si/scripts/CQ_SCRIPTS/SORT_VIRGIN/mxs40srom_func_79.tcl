...
if {$DUT <= $TVIIBE2M_SILICON} {
	set CM4_IN_DEEP_SLEEP 0x00000013;
	set CM4_IN_ACTIVE 0x00000010;
} else {
...
if {$DUT <= $TVIIBE2M_SILICON} {
	test_compare $STATUS_SUCCESS [SROM_SoftReset $SYS_CALL_VIA_SRAM_SCRATCH $ONLY_CM4_RESET];
} else {
