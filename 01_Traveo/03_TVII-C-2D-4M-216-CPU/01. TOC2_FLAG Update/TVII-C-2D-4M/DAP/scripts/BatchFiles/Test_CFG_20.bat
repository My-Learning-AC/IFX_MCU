...
set LOGPATH_TEST="Reports\Regression_002\CFG_20\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_20\Helper"
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_116.tcl 1> %LOGPATH_TEST%\mxs40srom_func_116.txt 2> %LOGPATH_TEST%\mxs40srom_func_116_error.txt
