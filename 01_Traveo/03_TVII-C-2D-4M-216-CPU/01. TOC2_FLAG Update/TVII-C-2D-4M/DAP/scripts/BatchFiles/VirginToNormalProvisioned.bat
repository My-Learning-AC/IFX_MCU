...
set LOGPATH="4M_PSVP\R03_SortToNormalP"
...
@rem %OPEN_OCD% -f HelperScripts\UpdateTOC1.tcl > %LOGPATH%\6A_UpdateTOC1.txt
@rem %OPEN_OCD% -f HelperScripts\UpdateTOC2.tcl > %LOGPATH%\6A_UpdateTOC2.txt
@rem %OPEN_OCD% -f HelperScripts\UpdateUID.tcl > %LOGPATH%\6B_UpdateUID.txt
