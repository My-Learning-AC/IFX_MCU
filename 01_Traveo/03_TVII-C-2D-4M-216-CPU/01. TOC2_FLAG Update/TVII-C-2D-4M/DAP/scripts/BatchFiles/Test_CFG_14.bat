...
set LOGPATH_TEST="Reports\Regression_002\CFG_14\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_14\Helper"
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\UpdateNAR_NDAR_For_ND_LifeCycle.tcl 1> %LOGPATH_HELPER%\UpdateNAR_NDAR_For_ND_LifeCycle.txt 2> %LOGPATH_HELPER%\UpdateNAR_NDAR_For_ND_LifeCycle_error.txt
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_84.tcl 1> %LOGPATH_TEST%\mxs40srom_func_84.txt 2> %LOGPATH_TEST%\mxs40srom_func_84_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_85.tcl 1> %LOGPATH_TEST%\mxs40srom_func_85.txt 2> %LOGPATH_TEST%\mxs40srom_func_85_error.txt
