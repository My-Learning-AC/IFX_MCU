...
%OPEN_OCD% -f HelperScripts\NormalProvisionedToSecureAccessRestrictions.tcl > %LOGPATH%\12_NormalProvisionedToSecureAccessRestrictions.txt
%OPEN_OCD% -f HelperScripts\BasicTest.tcl > %LOGPATH%\13_BasicTest.txt
%OPEN_OCD% -f CQ_SCRIPTS\SECURE_SECURE\TestSecureAcessRestrictions.tcl > %LOGPATH%\13_TestSecureDebugAcessRestrictions.txt