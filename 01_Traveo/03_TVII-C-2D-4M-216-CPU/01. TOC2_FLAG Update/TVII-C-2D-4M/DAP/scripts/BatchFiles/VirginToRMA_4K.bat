...
set LOGPATH="Report\Log_LifeCycleConversion_01\RMA_4K"
...
%OPEN_OCD% -f HelperScripts\Program_4K_RSA_Support.tcl > %LOGPATH%\1A_Program_4K_RSA_Support.txt
%OPEN_OCD% -f HelperScripts\Program_uid.tcl > %LOGPATH%\2A_PreReq_4_UpdateUID.txt
%OPEN_OCD% -f HelperScripts\Program_PKey_4K.tcl > %LOGPATH%\2B_PreReq_Program_PKEY_4K.txt
...
%OPEN_OCD% -f HelperScripts\Program_secure_hex_4k.tcl > %LOGPATH%\5B_Program_SecureHex_4K.txt
...
%OPEN_OCD% -f RMA\SROM_TransitionToRMA_122.4k.tcl > %LOGPATH%\7_TransitionToRMA_4K.txt
%OPEN_OCD% -f HelperScripts\OpenRma_lowLevel_4K.tcl > %LOGPATH%\8_OpenRMA_4K.txt
