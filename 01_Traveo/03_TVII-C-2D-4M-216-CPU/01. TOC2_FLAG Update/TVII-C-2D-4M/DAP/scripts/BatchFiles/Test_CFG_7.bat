...
set LOGPATH_TEST="Reports\Apoorva\Regression_002\CFG_7\Test"
set LOGPATH_HELPER="Reports\Apoorva\Regression_002\CFG_7\Helper"
...
@rem %OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_68.tcl 1> %LOGPATH_TEST%\mxs40srom_func_68.txt 2> %LOGPATH_TEST%\mxs40srom_func_68_error.txt
@rem %OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_110.tcl 1> %LOGPATH_TEST%\mxs40srom_func_110.txt 2> %LOGPATH_TEST%\mxs40srom_func_110_error.txt
@rem %OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_201.tcl 1> %LOGPATH_TEST%\mxs40srom_func_201.txt 2> %LOGPATH_TEST%\mxs40srom_func_201_error.txt
