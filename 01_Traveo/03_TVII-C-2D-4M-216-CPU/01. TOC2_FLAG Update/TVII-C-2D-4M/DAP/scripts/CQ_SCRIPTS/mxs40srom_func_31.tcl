...
#------------------------------------------------------------------
#ComputeHash
set TestString "Test FUNC_31a SROM_ConfigureRegionBulk: SRAM";
test_start $TestString;
set StartAddress 0x28000000
set EndAddress 0x28000200
set DataByte 0xA5
test_compare 0xA0000000 [SROM_ConfigureRegionBulk $SYS_CALL_GREATER32BIT $StartAddress $EndAddress $DataByte];
test_end $TestString;

set TestString "Test FUNC_31b SROM_ConfigureRegionBulk: MMIO";
test_start $TestString;
set CryptoMemBufStartAddr 0x40108000
set CryptoMemBufEndAddr 0x40108200
set DataByte 0xA5
test_compare 0xA0000000 [SROM_ConfigureRegionBulk $SYS_CALL_GREATER32BIT $CryptoMemBufStartAddr $CryptoMemBufEndAddr $DataByte];
test_end $TestString;

set TestString "Test FUNC_31c SROM_ConfigureRegionBulk: EndAddr < Start Addr";
test_start $TestString;
