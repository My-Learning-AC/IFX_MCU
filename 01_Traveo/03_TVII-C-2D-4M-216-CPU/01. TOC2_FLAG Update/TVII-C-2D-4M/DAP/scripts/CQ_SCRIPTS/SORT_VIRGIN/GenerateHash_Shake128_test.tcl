...
test_end $TestString;
IOR $SRAM_SCRATCH_DATA_ADDR
IOR [expr $SRAM_SCRATCH_DATA_ADDR + 0x4];
IOR [expr $SRAM_SCRATCH_DATA_ADDR + 0x8];
IOR [expr $SRAM_SCRATCH_DATA_ADDR + 0xC];
IOR [expr $SRAM_SCRATCH_DATA_ADDR + 0x10];
