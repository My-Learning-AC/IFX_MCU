...
#DO NOT MODIFY
# Pre-requisites : Program Invalid PKEY and correct UID to test this. This can only be done before SECURE
# conversion. Either in NORMAL or SECURE.
...
if {$CurrentProtection != $PS_SECURE} {
   puts " Not valid for protection state other than VIRGIN: FAIL"
	...
	set TestString "Test: Transition to RMA API with invalid PKEY";
	#Fixed Magic Number
	...
	test_compare $STATUS_INVALID_PUBLIC_KEY [SROM_TransitionToRMA $SYS_CALL_GREATER32BIT $lenOfObjects $cert $signWord];
