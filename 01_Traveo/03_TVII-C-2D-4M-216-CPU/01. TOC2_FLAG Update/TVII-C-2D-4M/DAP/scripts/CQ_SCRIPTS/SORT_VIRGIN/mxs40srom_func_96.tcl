...
if {$protState != $PS_VIRGIN} {
	...
	set TestString "Test : Write row in  Sflash row when DATA in SRAM is read protected";
	test_start $TestString;
	set sFlash_sl_addr 0x17000800 ;
	test_compare $STATUS_ADDR_PROTECTED [SROM_WriteRow $SYS_CALL_GREATER32BIT 0 $sFlash_sl_addr 0 $userrow];
	test_end $TestString;	
