...
if {($CurrentProtection != $PS_SECURE)} {
	...
	#set unique_id [list 0x00000000 0x00000000 0x00000000];
	...
	test_compare $STATUS_INVALID_SIGN [SROM_TransitionToRMA $SYS_CALL_GREATER32BIT $lenOfObjects $cert $signWord];
