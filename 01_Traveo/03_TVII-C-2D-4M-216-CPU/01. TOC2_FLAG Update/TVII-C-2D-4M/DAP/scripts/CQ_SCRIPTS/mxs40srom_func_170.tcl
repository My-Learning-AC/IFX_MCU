...
test_compare 0xA0000000 [SROM_SwitchOverRegulator $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $REGHC $EXTERNAL_TRANSISTOR];
test_end $TestString;

# Acquire the silicon in test mode
acquire_TestMode_SROM;

#Cannot switch back to LDO when DAP is connected
