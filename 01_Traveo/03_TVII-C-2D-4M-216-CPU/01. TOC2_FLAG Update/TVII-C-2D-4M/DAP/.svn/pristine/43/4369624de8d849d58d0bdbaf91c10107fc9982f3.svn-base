...
set LOGPATH_TEST="Reports\Regression_001\CFG1\Test"
set LOGPATH_HELPER="Reports\Regression_001\CFG1\Helper"
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_55.tcl 1> %LOGPATH_TEST%\mxs40srom_func_55.txt 2> %LOGPATH_TEST%\mxs40srom_func_55_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_58.tcl 1> %LOGPATH_TEST%\mxs40srom_func_58.txt 2> %LOGPATH_TEST%\mxs40srom_func_58_error.txt
