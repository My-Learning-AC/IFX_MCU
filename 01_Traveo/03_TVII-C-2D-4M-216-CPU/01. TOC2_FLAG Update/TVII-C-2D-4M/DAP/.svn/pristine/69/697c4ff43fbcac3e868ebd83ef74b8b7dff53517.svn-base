...
set LOGPATH_TEST="Reports\Regression_002\CFG_2\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_2\Helper"
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\Program_FLL_CTL_1.tcl 1> %LOGPATH_HELPER%\Program_FLL_CTL_1.txt 2> %LOGPATH_HELPER%\Program_FLL_CTL_1_error.txt
%OPEN_OCD% -f %HELPER_SCRIPTS%\ReadSflash.tcl 1> %LOGPATH_HELPER%\ReadSflash.txt 2> %LOGPATH_HELPER%\ReadSflash_error.txt
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\NormalProvisionedToSecureDebug.tcl 1> %LOGPATH_HELPER%\NormalProvisionedToSecureDebug.txt 2> %LOGPATH_HELPER%\NormalProvisionedToSecureDebug_error.txt
%OPEN_OCD% -f %HELPER_SCRIPTS%\BasicTest.tcl 1> %LOGPATH_HELPER%\BasicTest_5.txt 2> %LOGPATH_HELPER%\BasicTest_5_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_60.tcl 1> %LOGPATH_TEST%\mxs40srom_func_60.txt 2> %LOGPATH_TEST%\mxs40srom_func_60_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_123.tcl 1> %LOGPATH_TEST%\mxs40srom_func_123.txt 2> %LOGPATH_TEST%\mxs40srom_func_123_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_125.tcl 1> %LOGPATH_TEST%\mxs40srom_func_125.txt 2> %LOGPATH_TEST%\mxs40srom_func_125_error.txt
