...
#------------------------------------------------------------------
set TestString "Test FUNC_42a: EraseSector: Main Flash Large Sector";
...
set TestString "Test FUNC_42b: ProgramRow: MAIN FLASH LG Sector's 4096 bits";
test_start $TestString;
...
set TestString "Test FUNC_42c: EraseSector: Main Flash Large Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $FLASH_START_ADDR $FM_INTR_MASK_RESET];
...
test_end $TestString;
#------------------------------------------------------------------
set TestString "Test FUNC_42d: EraseSector: Main Flash Small Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
...
set TestString "Test FUNC_42e: ProgramRow MAIN FLASH SM Sector's 4096 bits";
test_start $TestString;
...
set TestString "Test FUNC_42f: EraseSector: Main Flash Small Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING [expr $FLASH_START_ADDR + $FLASH_SIZE - $MAIN_FLASH_SM_SIZE] $FM_INTR_MASK_RESET];
#proc SROM_Checksum {sysCallType rowID wholeFlash FlashType bank} {
...
set TestString "Test FUNC_42g: EraseSector: Main Flash Large Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $FLASH_START_ADDR $FM_INTR_MASK_RESET];
#proc SROM_Checksum {sysCallType rowID wholeFlash FlashType bank} {
...
set TestString "Test FUNC_42h: ProgramRow: MAIN FLASH LG Sector's 256bits";
...
set TestString "Test FUNC_42i: EraseSector: Main Flash Large Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $FLASH_START_ADDR $FM_INTR_MASK_RESET];
#proc SROM_Checksum {sysCallType rowID wholeFlash FlashType bank} {
...
#------------------------------------------------------------------
set TestString "Test FUNC_42j: EraseSector: Main Flash Small Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING [expr $FLASH_START_ADDR + $FLASH_SIZE - $MAIN_FLASH_SM_SIZE] $FM_INTR_MASK_RESET];
#proc SROM_Checksum {sysCallType rowID wholeFlash FlashType bank} {
...
set TestString "Test FUNC_42k: ProgramRow MAIN FLASH SM Sector's 256 bits";
test_start $TestString;
...
set TestString "Test FUNC_42l: EraseSector: Main Flash Small Sector";
test_start $TestString;
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING [expr $FLASH_START_ADDR + $FLASH_SIZE - $MAIN_FLASH_SM_SIZE] $FM_INTR_MASK_RESET];
set rowID 0x0;
test_compare 0xA0000000 [SROM_Checksum $SYS_CALL_GREATER32BIT $rowID $WHOLE_FLASH $FLASH_REGION_MAIN $BANK0];
...
set TestString "Test FUNC_42m: EraseSector: Main Flash Large Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $FLASH_START_ADDR $FM_INTR_MASK_RESET];
#proc SROM_Checksum {sysCallType rowID wholeFlash FlashType bank} {
...
set TestString "Test FUNC_42n: ProgramRow: MAIN FLASH LG Sector's 64bits";
...
set TestString "Test FUNC_42o: EraseSector: Main Flash Large Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $FLASH_START_ADDR $FM_INTR_MASK_RESET];
#proc SROM_Checksum {sysCallType rowID wholeFlash FlashType bank} {
...
test_end $TestString;
#------------------------------------------------------------------
set TestString "Test FUNC_42p: ProgramRow: MAIN FLASH SM Sector's 64 bits";
test_start $TestString;
...
set TestString "Test FUNC_42q: EraseSector: Main Flash Small Sector";
test_start $TestString;
#proc SROM_EraseSector {sysCallType blockCM0p flashAddr intrMask} {
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING [expr $FLASH_START_ADDR + $FLASH_SIZE - $MAIN_FLASH_SM_SIZE] $FM_INTR_MASK_RESET];
#proc SROM_Checksum {sysCallType rowID wholeFlash FlashType bank} {
...
set TestString "Test FUNC_42r: ProgramRow MAIN FLASH SM Sector's 256 bits";
test_start $TestString;
test_compare 0xA0000000 [SROM_ProgramRow $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $SKIP_BLANK_CHECK_EN $DATA_WIDTH_64BITS $DATA_LOC_SARM $FM_INTR_MASK_RESET [expr $FLASH_START_ADDR + $FLASH_SIZE - $MAIN_FLASH_SM_SIZE] $userrow];
set rowID [expr ($FLASH_SIZE - $MAIN_FLASH_SM_SIZE)/$FLASH_ROW_SIZE];
test_compare 0xA0000000 [SROM_Checksum $SYS_CALL_GREATER32BIT $rowID $PAGE $FLASH_REGION_MAIN $BANK0];
...
set TestString "Test FUNC_42s: EraseSector: Main Flash Small Sector";
test_start $TestString;
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING [expr $FLASH_START_ADDR + $FLASH_SIZE - $MAIN_FLASH_SM_SIZE] $FM_INTR_MASK_RESET];
set rowID 0x0;
test_compare 0xA0000000 [SROM_Checksum $SYS_CALL_GREATER32BIT $rowID $WHOLE_FLASH $FLASH_REGION_MAIN $BANK0];
...
#------------------------------------------------------------------
###########
set TestString "Test FUNC_42t: EraseSector: Work Flash Large Sector";
test_start $TestString;
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $WFLASH_START_ADDR $FM_INTR_MASK_RESET];
test_end $TestString;

set TestString "Test FUNC_42u: ProgramRow: WORK FLASH LG Sector";
test_start $TestString;
...
set TestString "Test FUNC_42v: EraseSector: Work Flash Large Sector";
test_start $TestString;
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $WFLASH_START_ADDR $FM_INTR_MASK_RESET];
test_end $TestString;
#------------------------------------------------------------------
set TestString "Test FUNC_42w: EraseSector: Work Flash Small Sector";
test_start $TestString;
...
set TestString "Test FUNC_42x: ProgramRow: WFLASH SM Sector";
test_start $TestString;
...
set TestString "Test FUNC_42y: EraseSector: Work Flash Small Sector";
test_start $TestString;
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING [expr $WFLASH_START_ADDR + $WFLASH_SIZE - $WORK_FLASH_SM_SIZE] $FM_INTR_MASK_RESET];
test_end $TestString;
#------------------------------------------------------------------
#------------------------------------------------------------------
set TestString "Test FUNC_42z: CheckSum: SFLASH";
test_start $TestString;
