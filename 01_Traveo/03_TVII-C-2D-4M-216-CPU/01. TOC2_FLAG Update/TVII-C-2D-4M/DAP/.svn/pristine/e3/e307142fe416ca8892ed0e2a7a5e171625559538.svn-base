# ####################################################################################################
# This script executes smpu and ppu checks
...
set TestString "Test AAxxx: CHECK FOR BOOT CHECKS WITH SMPU AND PPU CONFIGS";
test_start $TestString;
test_compare 0x00000000 [ReadPpuSmpuChecksTv2];
test_end $TestString;
