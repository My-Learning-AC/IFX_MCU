...
set expectedVal_1 [expr ($STATUS_SUCCESS | ([IOR 0x17000600]&0xFFFFFF))];
set expectedVal_2 [expr (([IOR 0x17000600]>>24) & 0xFF) | (([IOR 0x17000604]&0xFFFFFF)<<8)]
set expectedVal_3 [expr (([IOR 0x17000604]>>24) & 0xFF) | (([IOR 0x17000608]&0xFFFFFF)<<8)]
set TestString "Test : ReadUniqueId";
test_start $TestString;
test_compare $expectedVal_1 [SROM_ReadUniqueID $SYS_CALL_GREATER32BIT];
test_compare $expectedVal_2 [IOR [expr $SRAM_SCRATCH + 4]];
test_compare $expectedVal_3 [IOR [expr $SRAM_SCRATCH + 8]];
test_end $TestString;
