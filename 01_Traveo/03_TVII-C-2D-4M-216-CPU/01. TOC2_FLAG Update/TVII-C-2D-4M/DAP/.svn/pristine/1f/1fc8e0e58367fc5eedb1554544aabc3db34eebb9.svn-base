...
%OPEN_OCD% -f HelperScripts\ProvisionedToNormalProvisionedMinusBFuses.tcl > %LOGPATH%\10B_ProvToNorProvMinusBFuse.txt
%OPEN_OCD% -f HelperScripts\BasicTest.tcl > %LOGPATH%\11_BasicTest.txt
%OPEN_OCD% -f CQ_SCRIPTS\SORT_VIRGIN\mxs40srom_func_121.tcl > %LOGPATH%\12_mxs40srom_func_121.txt
