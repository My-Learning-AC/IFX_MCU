...
#------------------------------------------------------------------
ReadSFlashRow 1
set TestString "Test FUNC_40a CheckTrims before Calibrate";
test_start $TestString;
test_compare 0x0 [checkTrim];
test_end $TestString;

set TestString "Test FUNC_40b SROM_Calibrate: EnableEfuse = 0";
test_start $TestString;
test_compare 0xA0000000 [SROM_Calibrate $SYS_CALL_GREATER32BIT 0x0 0x0];
test_end $TestString;

set TestString "Test FUNC_40c CheckTrims after Calibrate";
test_start $TestString;
test_compare 0x0 [checkTrim];
test_end $TestString;
shutdown;
set TestString "Test FUNC_40d SROM_Calibrate: EnableEfuse = 0";
test_start $TestString;
test_compare 0xA0000000 [SROM_Calibrate $SYS_CALL_GREATER32BIT 0x0 0x0];
test_end $TestString;

set TestString "Test FUNC_40e CheckTrims after Calibrate";
test_start $TestString;
test_compare 0x0 [checkTrim];
test_end $TestString;
