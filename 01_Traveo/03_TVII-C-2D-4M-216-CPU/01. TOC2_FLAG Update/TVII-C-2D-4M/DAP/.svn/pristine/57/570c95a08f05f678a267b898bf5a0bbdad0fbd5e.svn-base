...
set LOGPATH_TEST="Reports\Regression_002\CFG_11\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_11\Helper"
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\NormalProvisionedToSecureAccessRestrictions.tcl 1> %LOGPATH_HELPER%\NormalProvisionedToSecureAccessRestrictions.txt 2> %LOGPATH_HELPER%\NormalProvisionedToSecureAccessRestrictions_error.txt
%OPEN_OCD% -f %HELPER_SCRIPTS%\BasicTest.tcl 1> %LOGPATH_HELPER%\BasicTest_5.txt 2> %LOGPATH_HELPER%\BasicTest_5_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_75.tcl 1> %LOGPATH_TEST%\mxs40srom_func_75.txt 2> %LOGPATH_TEST%\mxs40srom_func_75_error.txt
