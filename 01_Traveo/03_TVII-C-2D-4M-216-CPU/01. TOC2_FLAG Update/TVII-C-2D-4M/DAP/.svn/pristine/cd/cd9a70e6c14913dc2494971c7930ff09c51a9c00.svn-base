...
if {($CurrentProtection != $PS_VIRGIN)} {
	...
	test_start $TestString;
	test_compare $STATUS_INVALID_HASH_OBJECT_ADDRESS [SROM_GenerateHash $SYS_CALL_GREATER32BIT 2];
	test_end $TestString;
	...
	set TestString "Test AAxxx: UPDATE TOC2 TO RESTORE MAGIC KEY";
	test_start $TestString;
	set Toc2 [ReturnSFlashRow $TOC2_ROW_IDX];
	puts "Toc2 = $Toc2";		
