# ####################################################################################################
# This script executes Normal Provisioned to secure dead conversion for TVII-B-H-8M silicon
# Author: H ANKUR SHENOY
# Note: To be tested on PSVP, non recoverable transition to dead on silicon
# ####################################################################################################
...
#Transit_NormalPov_To_SecureDead $BLOW_SD_FUSE $SecureAccessRestrictions $DeadAccessRestrictions;
