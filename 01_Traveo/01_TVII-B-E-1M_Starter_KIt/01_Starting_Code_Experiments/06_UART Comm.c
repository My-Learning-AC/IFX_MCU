...
cy_stc_scb_uart_config_t    g_stc_uart_config = {
                                                   ...
                                                   .rxFifoIntEnableMask        = E_UART_RX_INTR_FACTER,    // If here we use 0, then it also works
                                                   .txFifoTriggerLevel         = 0,
                                                   .txFifoIntEnableMask        = E_UART_TX_INTR_FACTER     // If here we use 0, then it also works
                                                };
...
int main(void)
{
 ...
 //   uint8_t     comment[] = "UART Test";
  ...
  //  uint32_t    minor = CY_SCB_DRV_VERSION_MINOR;
   ...
   // TERM_PRINT_H("\n%s (ver=%d.%d)\n", comment, major, minor);
    TERM_PRINT_H("\n%s","I am trying to disply something for testing");
