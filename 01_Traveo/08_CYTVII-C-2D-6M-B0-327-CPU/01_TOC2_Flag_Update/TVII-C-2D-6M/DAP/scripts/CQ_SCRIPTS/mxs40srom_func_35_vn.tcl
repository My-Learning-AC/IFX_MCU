...
if {($CurrentProtection == $PS_VIRGIN) || ($CurrentProtection == $PS_NORMAL)} {
	...
	set func_addr_typ0_flash [expr (0x10000b31 & 0x3FFFFF)];
	...
	set TestString "1. Test FUNC_36: DIRECTEXECUTE API: Code in FLASH Tpe0";
	...
	set TestString "3. Test FUNC_36: DIRECTEXECUTE API: Code in FLASH Tpe0";
	test_start $TestString;
	SROM_DirectExecute $api_call_type $func_type $addr $argument $return $code_placed;
	test_end $TestString;
