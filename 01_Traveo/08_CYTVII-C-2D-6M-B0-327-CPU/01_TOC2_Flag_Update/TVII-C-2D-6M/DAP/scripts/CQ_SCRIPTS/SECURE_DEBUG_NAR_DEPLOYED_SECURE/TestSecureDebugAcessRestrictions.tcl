...
if {($CurrentProtection != $PS_SECURE)} {
	...
	test_start $TestString;
	test_compare 0x0 [IOR [expr $FLASH_START_ADDR + ($FLASH_SIZE*7/8)]];  #This will cause openocd to crash. uncomment test and comment to test next
	...
	test_start $TestString;
	test_compare 0x0 [IOR [expr $SFLASH_START_ADDR + ($SFLASH_SIZE/2)]]; #This will cause openocd to crash. uncomment test and comment to test next
