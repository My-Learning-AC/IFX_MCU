...
if { $protState != $PS_VIRGIN} {
    ...
    test_compare 0x0 [IOR $PERI_MS_PPU_FX0_SL_ADDR];
    test_compare 0x0 [IOR [expr $PERI_MS_PPU_FX0_SL_ADDR + 0x20]];
	...
	for {set wound_prog 0} {$wound_prog < 32} {incr wound_prog} {
		...
		test_start $TestString;
		test_compare [expr ([IOR 0x17000014]>>$wound_prog) &0x1] [IOR [expr $PERI_MS_WOUND_PROG0_ADDR + 4*$wound_prog]];
		test_end $TestString;
	}	
	set addr 0x17000018;
