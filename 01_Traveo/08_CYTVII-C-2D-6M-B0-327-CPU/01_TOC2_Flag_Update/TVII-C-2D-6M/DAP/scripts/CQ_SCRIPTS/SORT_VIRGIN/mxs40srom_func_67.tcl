...
Enable_MainFlash_Operations;
#Halt and read PC
set TestString "Test FUNC_67: Read PC value, it should be a ROM address";
test_start $TestString;
set pcVal [ReadPC];
#test_compare 0x00000344 [ReadPC];
if {($pcVal > $SROM_START_ADDR) && ($pcVal < $SROM_END_ADDR)} {
    puts "DEVICE IN IDLE STATE: PASS";
} else {
    puts "DEVICE IN IDLE STATE: FAIL";
}
test_end $TestString;
