...
set TestString "Test FUNC_49a: EraseSuspend: API usage when no erase is ongoing";
test_start $TestString;
test_compare $STATUS_NO_ERASE_ONGOING [SROM_EraseSuspend $SYS_CALL_LESS32BIT];
test_end $TestString;

set TestString "Test FUNC_49b: EraseSuspend: API usage when no erase is ongoing";
test_start $TestString;
test_compare $STATUS_NO_ERASE_ONGOING [SROM_EraseSuspend $SYS_CALL_GREATER32BIT];
test_end $TestString;
