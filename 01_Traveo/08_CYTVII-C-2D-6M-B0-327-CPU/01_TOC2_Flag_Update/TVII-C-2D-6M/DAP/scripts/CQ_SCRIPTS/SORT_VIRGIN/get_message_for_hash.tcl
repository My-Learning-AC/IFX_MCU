...
set trim_size [expr [expr [IOR $trim_addr] & 0x0000FFFF] + 0x2]
set uid_addr [IOR 0x17007818]
set uid_size 12
set fb_addr [IOR 0x1700781C]
set fb_size [IOR $fb_addr]
set syscall_addr 0x17000004
set syscall_size 4
set toc1_addr 0x17007800
set toc1_size 512
set bprot_addr [IOR 0x17007828]
set bprot_size [IOR $bprot_addr]
set otp_addr [IOR 0x1700782C]
set otp_size [IOR $otp_addr]
set row0_addr 0x17000000
set row0_size 512
#set fb_patch_addr [IOR 0x17007834]
#set fb_patch_size [IOR $fb_patch_addr]

puts [format "Trim Addr: $trim_addr"]
#puts [format "Original: [IOR $trim_addr]"]
