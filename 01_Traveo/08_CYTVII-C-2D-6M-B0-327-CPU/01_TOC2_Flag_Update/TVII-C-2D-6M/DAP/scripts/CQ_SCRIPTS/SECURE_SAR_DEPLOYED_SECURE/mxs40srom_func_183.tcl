...
set sramWound [expr 0x3FF & [IOR $CYREG_CPUSS_WOUNDING]];

if {$sramWound > 0} {
	set SiliconId_Lo [IOR_byte_AP 0x0 0x17000002];
	set SiliconId_Hi [IOR_byte_AP 0x0 0x17000003];

	set ExpectedResult [expr 0xa0510000 | [expr $SiliconId_Hi << 8] | [expr $SiliconId_Lo]];
    ...
    puts " Test case is meant to be executed with SRAM wounded but this device has no wounding for SRAM: FAIL";
}
