# ####################################################################################################
# This script executes TransitionToRMA conversion for TVII-B-H-8M silicon
...
set result [SROM_TransitionToRMA $SYS_CALL_GREATER32BIT $lenOfObjects $cert $signWord];
IOR 0x4022006C;
