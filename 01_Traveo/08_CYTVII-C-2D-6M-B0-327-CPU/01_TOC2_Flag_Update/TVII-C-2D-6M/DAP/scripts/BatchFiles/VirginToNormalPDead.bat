...
set LOGPATH="Log_LifeCycleConversion\TVIIBH8M_B0\SECURE_DEAD_CORRUPT_HASH_%SUBFILENAME%"
...
%OPEN_OCD% -f HelperScripts\UpdateNAR_NDAR_For_ND_LifeCycle.tcl >%LOGPATH%\2B_PreReq_2_UpdateNAR_NDAR.txt
...
%OPEN_OCD% -f HelperScripts\UpdateHashOnTrims_CorruptIt.tcl > %LOGPATH%\10_CorruptHashOnTrims.txt
%OPEN_OCD% -f HelperScripts\ProvisionedToNormalProvisioned.tcl > %LOGPATH%\11_ProvToNormP.txt
%OPEN_OCD% -f HelperScripts\BasicTest.tcl > %LOGPATH%\12_BasicTest.txt
%OPEN_OCD% -f CQ_SCRIPTS\NORMAL_DEAD\TestNormalDeadAcessRestrictions.tcl > %LOGPATH%\13_TestNormalDeadAcessRestrictions.txt
