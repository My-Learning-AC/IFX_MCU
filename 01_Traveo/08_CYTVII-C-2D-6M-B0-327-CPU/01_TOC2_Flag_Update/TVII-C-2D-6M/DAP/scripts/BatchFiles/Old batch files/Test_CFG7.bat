...
set LOGPATH_TEST="Reports\Regression_001\CFG7\Test"
set LOGPATH_HELPER="Reports\Regression_001\CFG7\Helper"
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_68.tcl 1> %LOGPATH_TEST%\mxs40srom_func_68.txt 2> %LOGPATH_TEST%\mxs40srom_func_68_error.txt
