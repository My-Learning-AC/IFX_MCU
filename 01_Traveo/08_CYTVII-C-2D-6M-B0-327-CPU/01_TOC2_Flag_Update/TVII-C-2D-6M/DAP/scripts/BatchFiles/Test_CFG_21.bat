...
set LOGPATH_TEST="Reports\Regression_002_RMA_test\CFG_21\Test"
set LOGPATH_HELPER="Reports\Regression_002_RMA_test\CFG_21\Helper"
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\UpdateUID.tcl 1> %LOGPATH_HELPER%\UpdateUID.txt 2> %LOGPATH_HELPER%\UpdateUID_error.txt
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\NormalProvisionedToSecureDebug.tcl 1> %LOGPATH_HELPER%\NormalProvisionedToSecure.txt 2> %LOGPATH_HELPER%\NormalProvisionedToSecure_error.txt
%OPEN_OCD% -f %HELPER_SCRIPTS%\BasicTest.tcl 1> %LOGPATH_HELPER%\BasicTest_5.txt 2> %LOGPATH_HELPER%\BasicTest_5_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_65.tcl 1> %LOGPATH_TEST%\mxs40srom_func_65.txt 2> %LOGPATH_TEST%\mxs40srom_func_65_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_126.tcl 1> %LOGPATH_TEST%\mxs40srom_func_126.txt 2> %LOGPATH_TEST%\mxs40srom_func_126_error.txt
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_128.tcl 1> %LOGPATH_TEST%\mxs40srom_func_128.txt 2> %LOGPATH_TEST%\mxs40srom_func_128_error.txt
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_130.tcl 1> %LOGPATH_TEST%\mxs40srom_func_130.txt 2> %LOGPATH_TEST%\mxs40srom_func_130_error.txt
