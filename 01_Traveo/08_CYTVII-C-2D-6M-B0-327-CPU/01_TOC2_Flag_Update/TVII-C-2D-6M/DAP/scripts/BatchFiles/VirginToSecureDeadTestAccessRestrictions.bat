...
%OPEN_OCD% -f HelperScripts\UpdateNAR_NDAR_For_SD_LifeCycle.tcl >%LOGPATH%\2B_PreReq_2_UpdateNAR_NDAR.txt
...
%OPEN_OCD% -f HelperScripts\NormalProvisionedToSecureDeadAccessRestrictions.tcl > %LOGPATH%\12_NormalProvisionedToSecureDeadAccessRestrictions.txt
%OPEN_OCD% -f HelperScripts\BasicTest.tcl > %LOGPATH%\13_BasicTest.txt
%OPEN_OCD% -f CQ_SCRIPTS\SECURE_DEAD\TestSecureDebugAcessRestrictions.tcl > %LOGPATH%\13_TestSecureDebugAcessRestrictions.txt