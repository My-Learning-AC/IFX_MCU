...
set LOGPATH_TEST="Reports\Regression_002\CFG_26\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_26\Helper"
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\ReadSflash.tcl 1> %LOGPATH_HELPER%\ReadSflash.txt 2> %LOGPATH_HELPER%\ReadSflash_error.txt
%OPEN_OCD% -f %HELPER_SCRIPTS%\VirginToSort_ApplyTrimsFromSflash_wound_mflash_2.tcl 1> %LOGPATH_HELPER%\VirginToSort_ApplyTrimsFromSflash_wound_mflash_2.txt 2> %LOGPATH_HELPER%\VirginToSort_ApplyTrimsFromSflash_wound_mflash_2_error.txt
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_21.tcl 1> %LOGPATH_TEST%\mxs40srom_func_21.txt 2> %LOGPATH_TEST%\mxs40srom_func_21_error.txt
