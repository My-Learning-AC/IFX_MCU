...
set LOGPATH_TEST="Reports\Regression_002\CFG_10\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_10\Helper"
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_74.tcl 1> %LOGPATH_TEST%\mxs40srom_func_74.txt 2> %LOGPATH_TEST%\mxs40srom_func_74_error.txt
