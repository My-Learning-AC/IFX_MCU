...
set LOGPATH_TEST="Reports\Regression_002\CFG_9\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_9\Helper"
...
%OPEN_OCD% -f %HELPER_SCRIPTS%\ReadSflash.tcl 1> %LOGPATH_HELPER%\ReadSflash.txt 2> %LOGPATH_HELPER%\ReadSflash_error.txt
%OPEN_OCD% -f %HELPER_SCRIPTS%\VirginToSort_ApplyTrimsFromSflash_disableWDT.tcl 1> %LOGPATH_HELPER%\VirginToSort_ApplyTrimsFromSflash_disableWDT.txt 2> %LOGPATH_HELPER%\VirginToSort_ApplyTrimsFromSflash_disableWDT_error.txt
...
%OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_72.tcl 1> %LOGPATH_TEST%\mxs40srom_func_72.txt 2> %LOGPATH_TEST%\mxs40srom_func_72_error.txt
