...
#DO NOT MODIFY
#This Script is valid for PSVP, SILICON, VIRGIN, NORMAL, SECURE, DEAD PROTECTION STATES, WOUNDED WFLASH/MFLASH
...
if {($CurrentProtection != $PS_VIRGIN)} {
	...
	set flashWound [expr 0x3 & ($wounding>>16)];
...
set TestString "Test FUNC_44: EraseSector: Invalid Flash Address";
