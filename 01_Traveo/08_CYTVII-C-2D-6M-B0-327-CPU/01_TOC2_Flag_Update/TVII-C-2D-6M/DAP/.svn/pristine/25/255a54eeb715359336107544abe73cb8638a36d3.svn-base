...
set LOGPATH_TEST="Reports\Regression_002\CFG_5\Test"
set LOGPATH_HELPER="Reports\Regression_002\CFG_5\Helper"
...
@rem %OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_34.tcl 1> %LOGPATH_TEST%\mxs40srom_func_34.txt 2> %LOGPATH_TEST%\mxs40srom_func_34_error.txt
@rem %OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_35.tcl 1> %LOGPATH_TEST%\mxs40srom_func_35.txt 2> %LOGPATH_TEST%\mxs40srom_func_35_error.txt
@rem %OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_36.tcl 1> %LOGPATH_TEST%\mxs40srom_func_36.txt 2> %LOGPATH_TEST%\mxs40srom_func_36_error.txt
@rem %OPEN_OCD% -f %TEST_SCRIPTS%\mxs40srom_func_37.tcl 1> %LOGPATH_TEST%\mxs40srom_func_37.txt 2> %LOGPATH_TEST%\mxs40srom_func_37_error.txt
