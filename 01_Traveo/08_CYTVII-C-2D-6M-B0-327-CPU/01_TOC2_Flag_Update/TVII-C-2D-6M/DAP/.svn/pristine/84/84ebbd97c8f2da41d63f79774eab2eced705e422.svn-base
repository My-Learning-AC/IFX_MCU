...
#------------------------------------------------------------------
set TestString "Test FUNC_158a: EraseSector: Suspend an erase";
...
#test_compare [expr 0xA0000000 | $ERASE_CODE | $ERS_SUSPEND] [SROM_CheckFmStatus $SYS_CALL_GREATER32BIT] ;
...
after 1000;
set TestString "Test FUNC_158b: EraseSector: When erase is suspended for the sector";
test_start $TestString;
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $FLASH_START_ADDR $FM_INTR_MASK_SET];
test_end $TestString;

set TestString "Test FUNC_158c: EraseSector: Suspend an erase";
test_start $TestString;
...
after 1000;
set TestString "Test FUNC_158d: EraseSector: When erase is suspended for the sector";
test_start $TestString;
test_compare 0xA0000000 [SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_BLOCKING $WFLASH_START_ADDR $FM_INTR_MASK_SET];
test_end $TestString;
