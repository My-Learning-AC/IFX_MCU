...
puts " EraseSector in non blocking\n"
SROM_EraseSector $SYS_CALL_GREATER32BIT $CM0P_NONBLOCKING $FLASH_START_ADDR $FM_INTR_MASK_RESET;
puts " Check Fm Status\n"


set stat [SROM_CheckFmStatus $SYS_CALL_GREATER32BIT];
while {$stat != 0xA0000000} {
    set stat [SROM_CheckFmStatus $SYS_CALL_GREATER32BIT];
}
