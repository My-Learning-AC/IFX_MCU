...
%OPEN_OCD% -f HelperScripts\NormalProvisionedToSecureDebugAccessRestrictions.tcl > %LOGPATH%\12_NormalProvisionedToSecureDebugAccessRestrictions.txt
%OPEN_OCD% -f HelperScripts\BasicTest.tcl > %LOGPATH%\13_BasicTest.txt
%OPEN_OCD% -f HelperScripts\TestSecureDebugAcessRestrictions.tcl > %LOGPATH%\13_TestSecureDebugAcessRestrictions.txt