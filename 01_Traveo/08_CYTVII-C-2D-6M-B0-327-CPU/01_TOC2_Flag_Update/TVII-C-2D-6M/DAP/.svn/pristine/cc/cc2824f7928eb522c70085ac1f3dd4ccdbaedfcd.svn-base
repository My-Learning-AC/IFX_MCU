# ####################################################################################################
# This script executes WriteRow API when data to be written is in read-protected SRAM
# Author: SUNIL NAYAK
# Tested on silicon!
# ####################################################################################################
...
puts "userrow = $userrow";
test_compare $STATUS_ADDR_PROTECTED [SROM_WriteRow $SYS_CALL_GREATER32BIT 0 0x17000800 0 $userrow];
test_end $TestString;

#EraseSector does not refer to any data but only parameters.
#set TestString "Test AAxxx: EraseSector when data in read protected sram";
#test_start $TestString;
#test_compare $STATUS_ADDR_PROTECTED [SROM_EraseSector $SYS_CALL_GREATER32BIT 1 0x10030000 0];
#test_end $TestString;

#set TestString "Test AAxxx: EraseSector when data in read protected sram";
#test_start $TestString;
#test_compare $STATUS_ADDR_PROTECTED [SROM_EraseSector $SYS_CALL_GREATER32BIT 1 0x14000000 0];
#test_end $TestString;

set TestString "Test AAxxx: ProgramRow when data in read protected sram";
test_start $TestString;
test_compare $STATUS_ADDR_PROTECTED [SROM_ProgramRow $SYS_CALL_GREATER32BIT 1 1 9 1 0 0x10030000 $userrow];
test_end $TestString;

set TestString "Test AAxxx: ProgramRow when data in read protected sram";
test_start $TestString;
test_compare $STATUS_ADDR_PROTECTED [SROM_ProgramRow $SYS_CALL_GREATER32BIT 1 1 2 1 0 0x14000000 $userrow];
test_end $TestString;
