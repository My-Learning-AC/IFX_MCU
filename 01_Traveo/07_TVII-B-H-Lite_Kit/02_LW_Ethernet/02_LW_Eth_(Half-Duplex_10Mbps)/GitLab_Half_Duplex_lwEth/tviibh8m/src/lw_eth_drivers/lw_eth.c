                      ...
                      stc_lw_eth_member_t* m)
{
    ...
    ((un_ETH_NETWORK_CONFIG_t){
        ...
        .stcField.u1FULL_DUPLEX                      = Full_Duplex,
        ...
        .stcField.u1EN_HALF_DUPLEX_RX                = true,   // note
    ...
    ((un_ETH_INT_ENABLE_t){
        ...
        .stcField.u1ENABLE_TRANSMIT_BUFFER_UNDER_RUN_INTERRUPT                   = false,
        ...
        .stcField.u1ENABLE_RECEIVE_OVERRUN_INTERRUPT                             = false,
        ...
        .stcField.u1ENABLE_PTP_SYNC_FRAME_RECEIVED                               = false,
        .stcField.u1ENABLE_PTP_DELAY_REQ_FRAME_TRANSMITTED                       = false,
        .stcField.u1ENABLE_PTP_SYNC_FRAME_TRANSMITTED                            = false,
        ...
        .stcField.u1ENABLE_TSU_SECONDS_REGISTER_INCREMENT                        = false,
        .stcField.u1ENABLE_RX_LPI_INDICATION_INTERRUPT                           = false,
        .stcField.u1ENABLE_TSU_TIMER_COMPARISON_INTERRUPT                        = false,
    }).u32Register;
