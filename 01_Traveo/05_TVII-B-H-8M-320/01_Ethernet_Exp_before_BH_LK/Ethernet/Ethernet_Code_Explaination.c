...
//#include "Gig_Eth_Macros/Gig_Eth_Macros.h"

/********************************************************/



#define EMAC_MII                0       // Media Independent Interface                      Speed upto - 100 Mbps
#define EMAC_RMII               1       // Reduced Media Independent Interface              Speed upto - 100 Mbps
#define EMAC_GMII               2       // Gigabit Media Independent Inteface               Speed upto - 1 Gbps
#define EMAC_RGMII              3       // Reduced Gigabit Media Independent Interface      Speed upto - 1 Gbps

#define ETH_LINKSPEED_10        10      // Link speed - 10 Mbps
#define ETH_LINKSPEED_100       100     // Link speed - 100 Mbps
#define ETH_LINKSPEED_1000      1000    // Link speed - 1000 Mbps or 1 Gbps
...
/********************************************************/
/** PHY Mode Selection      */
#define EMAC_INTERFACE              EMAC_RGMII                  // Sets the RGMII ( Reduced Gigabit Media Independent Interface ) Interface for reduce the pin number and maximum speed
#define EMAC_LINKSPEED              ETH_LINKSPEED_1000          // Link Speed is equal to 1 Gbps
...
/********************************************************/
#define ETH_REG_BASE         CY_GIG_ETH_TYPE                    //  Base address of the Ethernet

#define ETH_INTR_SRC         (CY_GIG_ETH_IRQN0)                 // Main Ethernet Interrupt Sourse
#define ETH_INTR_SRC_Q1      (CY_GIG_ETH_IRQN1)                 // Interrupt source for the queue 1 of the Ethernet Module
#define ETH_INTR_SRC_Q2      (CY_GIG_ETH_IRQN2)                 // Interrupt source for the queue 2 of the Ethernet Module
...
#define ETHx_TD0_PIN_MUX     CY_GIG_ETH_TD0_PIN_MUX             // Transmit Data 0 (TD0) PIN MUX

#define ETHx_TD1_PORT        CY_GIG_ETH_TD1_PORT
#define ETHx_TD1_PIN         CY_GIG_ETH_TD1_PIN
#define ETHx_TD1_PIN_MUX     CY_GIG_ETH_TD1_PIN_MUX             // Transmit Data 1 (TD1) PIN MUX

#define ETHx_TD2_PORT        CY_GIG_ETH_TD2_PORT
#define ETHx_TD2_PIN         CY_GIG_ETH_TD2_PIN
#define ETHx_TD2_PIN_MUX     CY_GIG_ETH_TD2_PIN_MUX             // Transmit Data 2 (TD2) PIN MUX

#define ETHx_TD3_PORT        CY_GIG_ETH_TD3_PORT
#define ETHx_TD3_PIN         CY_GIG_ETH_TD3_PIN
#define ETHx_TD3_PIN_MUX     CY_GIG_ETH_TD3_PIN_MUX             // Transmit Data 3 (TD3) PIN MUX

#define ETHx_TD4_PORT        CY_GIG_ETH_TD4_PORT
#define ETHx_TD4_PIN         CY_GIG_ETH_TD4_PIN
#define ETHx_TD4_PIN_MUX     CY_GIG_ETH_TD4_PIN_MUX             // Transmit Data 4 (TD4) PIN MUX

#define ETHx_TD5_PORT        CY_GIG_ETH_TD5_PORT
#define ETHx_TD5_PIN         CY_GIG_ETH_TD5_PIN
#define ETHx_TD5_PIN_MUX     CY_GIG_ETH_TD5_PIN_MUX             // Transmit Data 5 (TD5) PIN MUX

#define ETHx_TD6_PORT        CY_GIG_ETH_TD6_PORT
#define ETHx_TD6_PIN         CY_GIG_ETH_TD6_PIN
#define ETHx_TD6_PIN_MUX     CY_GIG_ETH_TD6_PIN_MUX             // Transmit Data 6 (TD6) PIN MUX

#define ETHx_TD7_PORT        CY_GIG_ETH_TD7_PORT
#define ETHx_TD7_PIN         CY_GIG_ETH_TD7_PIN
#define ETHx_TD7_PIN_MUX     CY_GIG_ETH_TD7_PIN_MUX             // Transmit Data 7 (TD7) PIN MUX

#define ETHx_TXER_PORT       CY_GIG_ETH_TXER_PORT
#define ETHx_TXER_PIN        CY_GIG_ETH_TXER_PIN
#define ETHx_TXER_PIN_MUX    CY_GIG_ETH_TXER_PIN_MUX            // Transmit Error (TX_ER) PIN MUX

#define ETHx_TX_CTL_PORT     CY_GIG_ETH_TX_CTL_PORT
#define ETHx_TX_CTL_PIN      CY_GIG_ETH_TX_CTL_PIN
#define ETHx_TX_CTL_PIN_MUX  CY_GIG_ETH_TX_CTL_PIN_MUX          // Transmit Control (TX_CTL) PIN MUX
...
#define ETHx_RD0_PIN_MUX     CY_GIG_ETH_RD0_PIN_MUX             // Receive Data 0 (RD0) PIN MUX

#define ETHx_RD1_PORT        CY_GIG_ETH_RD1_PORT
#define ETHx_RD1_PIN         CY_GIG_ETH_RD1_PIN
#define ETHx_RD1_PIN_MUX     CY_GIG_ETH_RD1_PIN_MUX             // Receive Data 1 (RD1) PIN MUX

#define ETHx_RD2_PORT        CY_GIG_ETH_RD2_PORT
#define ETHx_RD2_PIN         CY_GIG_ETH_RD2_PIN
#define ETHx_RD2_PIN_MUX     CY_GIG_ETH_RD2_PIN_MUX             // Receive Data 2 (RD2) PIN MUX

#define ETHx_RD3_PORT        CY_GIG_ETH_RD3_PORT
#define ETHx_RD3_PIN         CY_GIG_ETH_RD3_PIN
#define ETHx_RD3_PIN_MUX     CY_GIG_ETH_RD3_PIN_MUX             // Receive Data 3 (RD3) PIN MUX

#define ETHx_RD4_PORT        CY_GIG_ETH_RD4_PORT
#define ETHx_RD4_PIN         CY_GIG_ETH_RD4_PIN
#define ETHx_RD4_PIN_MUX     CY_GIG_ETH_RD4_PIN_MUX             // Receive Data 4 (RD4) PIN MUX

#define ETHx_RD5_PORT        CY_GIG_ETH_RD5_PORT
#define ETHx_RD5_PIN         CY_GIG_ETH_RD5_PIN
#define ETHx_RD5_PIN_MUX     CY_GIG_ETH_RD5_PIN_MUX             // Receive Data 5 (RD5) PIN MUX

#define ETHx_RD6_PORT        CY_GIG_ETH_RD6_PORT
#define ETHx_RD6_PIN         CY_GIG_ETH_RD6_PIN
#define ETHx_RD6_PIN_MUX     CY_GIG_ETH_RD6_PIN_MUX             // Receive Data 6 (RD6) PIN MUX

#define ETHx_RD7_PORT        CY_GIG_ETH_RD7_PORT
#define ETHx_RD7_PIN         CY_GIG_ETH_RD7_PIN
#define ETHx_RD7_PIN_MUX     CY_GIG_ETH_RD7_PIN_MUX             // Receive Data 7 (RD7) PIN MUX

#define ETHx_RX_CTL_PORT     CY_GIG_ETH_RX_CTL_PORT
#define ETHx_RX_CTL_PIN      CY_GIG_ETH_RX_CTL_PIN
#define ETHx_RX_CTL_PIN_MUX  CY_GIG_ETH_RX_CTL_PIN_MUX           // Receive Control (RX_CTL) PIN MUX

#define ETHx_RX_ER_PORT      CY_GIG_ETH_RX_ER_PORT
#define ETHx_RX_ER_PIN       CY_GIG_ETH_RX_ER_PIN
#define ETHx_RX_ER_PIN_MUX   CY_GIG_ETH_RX_ER_PIN_MUX             // Receive Error (RX_ER) PIN MUX
...
#define ETHx_TX_CLK_PIN_MUX  CY_GIG_ETH_TX_CLK_PIN_MUX          // Transmit Clock (TX_CLK) PIN MUX

#define ETHx_RX_CLK_PORT     CY_GIG_ETH_RX_CLK_PORT
#define ETHx_RX_CLK_PIN      CY_GIG_ETH_RX_CLK_PIN
#define ETHx_RX_CLK_PIN_MUX  CY_GIG_ETH_RX_CLK_PIN_MUX           // Receive Clock (RX_CLK) PIN MUX

#define ETHx_REF_CLK_PORT    CY_GIG_ETH_REF_CLK_PORT
#define ETHx_REF_CLK_PIN     CY_GIG_ETH_REF_CLK_PIN
#define ETHx_REF_CLK_PIN_MUX CY_GIG_ETH_REF_CLK_PIN_MUX           // Reference Clock PIN MUX

#define ETHx_MDC_PORT        CY_GIG_ETH_MDC_PORT
#define ETHx_MDC_PIN         CY_GIG_ETH_MDC_PIN
#define ETHx_MDC_PIN_MUX     CY_GIG_ETH_MDC_PIN_MUX              // Management Data Clock PIN MUX

#define ETHx_MDIO_PORT       CY_GIG_ETH_MDIO_PORT
#define ETHx_MDIO_PIN        CY_GIG_ETH_MDIO_PIN
#define ETHx_MDIO_PIN_MUX    CY_GIG_ETH_MDIO_PIN_MUX             // Management Data Input/Output PIN MUX
...
int main(void)
{
    ...
    cy_str_ethif_TSU_Config stcTSUConfig = {
        ...
        .enTxDescStoreTimeStamp = CEDI_TX_TS_DISABLED,      // Controls whether the time stamp of a transmitted frame is stored in the transmit descriptor or not 
        .enRxDescStoreTimeStamp = CEDI_RX_TS_DISABLED,      // Controls whether the time stamp of a received frame is stored in the receive descriptor or not
        .bStoreNSinRxDesc = false,                          // When enabled, this field would storethe nenosecond component of the time stamp in the receive descriptor for higher precesion
    };
...
// EMAC *****************
// --------- Ethernet Frame received callback function --------- //
static void Ethx_RxFrameCB ( cy_pstc_eth_type_t pstcEth, uint8_t * u8RxBuffer, uint32_t u32Length )
{
    bFrameReceived = true;
...
// --------- Ethernet Transmit Frame Successful function ---------- //
static void Ethx_TxFrameSuccessful ( cy_pstc_eth_type_t pstcEth, uint8_t u8QueueIndex, uint32_t bufIdx)
{
    bFrameTransmit = true;
    u16TransmitLength = u16TransmitLength + 64;
...
//    Cy_EthIf_PhyRegWrite(CY_ETH1_TYPE, 0x10, 0x5028, PHY_ADDR);         /** Disable auto neg for MDI/MDI-X YOTS in my case this is required **/
    ...
    Cy_EthIf_PhyRegWrite(ETH_REG_BASE, 0x1F, 0x4000, PHY_ADDR);         /** CTRL   */  // Perform a full restart    
...
*
*******************************************************************************/
// This function is used for whether the PHY is connected or not
static bool Check_DP83867IR_LinkStatus (void)
{
    uint32_t    u32ReadData = 0;   
    ...
    {
        /** Link up */ // PHY has successfully established a connection with the remote device
        return true;
    }
    else
    {
        /** Link down   */  // NO connection is present
        return false;
    }   
}
...
static bool Phy_DP83867IR_MDIO_validation (void)
{
    ...
    Cy_EthIf_PhyRegWrite(ETH_REG_BASE, 0x18, 0xD032, PHY_ADDR);         // Select all the 4 leds for Tx, Rx, Link Established and TxRx_Er
